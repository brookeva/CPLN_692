  ...
  */
  ...
  updateDataLayer(data) {
    ...
    var placeIcon = L.icon({
      iconUrl: './Images/place2.png',
      iconSize:     [40, 40], // size of the icon
      //iconAnchor:   [-9.146554542327749,
      //    38.715845814373296], // point of the icon which will correspond to marker's location
      //popupAnchor:  [-9.146554542327749,
      //    38.715845814373296] // point from which the popup should open relative to the iconAnchor
  });

    const geoJsonLayer = L.geoJSON(data, { pointToLayer: (p, latlng) => L.marker(latlng, {icon: placeIcon})})
